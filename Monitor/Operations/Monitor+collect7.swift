...
public func all<E, T1, T2, T3, T4, T5, T6, T7>(_ m1: Monitor<E, T1>,
                                               _ m2: Monitor<E, T2>,
                                               _ m3: Monitor<E, T3>,
                                               _ m4: Monitor<E, T4>,
                                               _ m5: Monitor<E, T5>,
                                               _ m6: Monitor<E, T6>,
                                               _ m7: Monitor<E, T7>) -> Monitor<E, (T1, T2, T3, T4, T5, T6, T7)> {
    typealias AT = (T1?, T2?, T3?, T4?, T5?, T6?, T7?)
    let accumulator = (nil, nil, nil, nil, nil, nil, nil) as AT
    let factory = CollectorFactory<E, E, T1, T2, T3, T4, T5, T6, T7, AT>(
        ephemeralMapper: unwrap(from:),
        accumulator: accumulator,
        terminalReducer: set)
    let void = Monitor(terminal: (), ephemeralType: Never.self)
    return mix(m1, m2, m3, m4, m5, m6, m7, void, void, factory: factory)
        .map(ephemeral: identity, terminal: unwrap)
}

public func all<E, T1: Result, T2: Result, T3: Result, T4: Result, T5: Result, T6: Result, T7: Result>(
    _ m1: Monitor<E, T1>,
    _ m2: Monitor<E, T2>,
    _ m3: Monitor<E, T3>,
    _ m4: Monitor<E, T4>,
    _ m5: Monitor<E, T5>,
    _ m6: Monitor<E, T6>,
    _ m7: Monitor<E, T7>) -> Monitor<E, Either<(T1.T, T2.T, T3.T, T4.T, T5.T, T6.T, T7.T), Error>> {
    typealias AT = Either<(T1.T?, T2.T?, T3.T?, T4.T?, T5.T?, T6.T?, T7.T?), Error>
    let accumulator = AT.left((nil, nil, nil, nil, nil, nil, nil))
    let factory = CollectorFactory<E, E, T1, T2, T3, T4, T5, T6, T7, AT>(
        ephemeralMapper: unwrap(from:),
        accumulator: accumulator,
        terminalReducer: set)
...
public func collect<E, ET, T1, T2, T3, T4, T5, T6, T7, AT>(
    ...
    _ m6: Monitor<E, T6>,
    _ m7: Monitor<E, T7>,
    ephemeralMapper: @escaping (OneOf7<E, E, E, E, E, E, E>) -> ET,
    accumulator: AT,
    terminalReducer: @escaping (inout AT, OneOf7<T1, T2, T3, T4, T5, T6, T7>) -> Bool) -> Monitor<ET, AT> {
...
private struct CollectorFactory<E, ET, T1, T2, T3, T4, T5, T6, T7, AT>: MonitorHetorogeneusMixingFactory {
    init(ephemeralMapper: @escaping (OneOf7<E, E, E, E, E, E, E>) -> ET,
         accumulator: AT,
         terminalReducer: @escaping (inout AT, OneOf7<T1, T2, T3, T4, T5, T6, T7>) -> Bool) {
        self.mapEphemeral = ephemeralMapper
        self.accumulator = accumulator
        self.reduceTerminal = terminalReducer
    }
    
    func make(feed: Feed<ET, AT>) -> Collector<E, ET, T1, T2, T3, T4, T5, T6, T7, AT> {
    ...
    typealias Mixer = Collector<E, ET, T1, T2, T3, T4, T5, T6, T7, AT>
    
    let mapEphemeral: (OneOf7<E, E, E, E, E, E, E>) -> ET
    let accumulator: AT
    let reduceTerminal: (inout AT, OneOf7<T1, T2, T3, T4, T5, T6, T7>) -> Bool
}

private final class Collector<E, ET, T1, T2, T3, T4, T5, T6, T7, AT>: MonitorHetorogeneusMixing {
    ...
    private func process(_ terminal: OneOf7<T1, T2, T3, T4, T5, T6, T7>) {
...
private func unwrap<T>(from value: OneOf7<T, T, T, T, T, T, T>) -> T {
    switch value {
    case .e1(let result):
        return result
    case .e2(let result):
...
private func set<T1, T2, T3, T4, T5, T6, T7>(
    to tuple: inout (T1?, T2?, T3?, T4?, T5?, T6?, T7?),
    value: OneOf7<T1, T2, T3, T4, T5, T6, T7>) -> Bool {
    switch value {
    case .e1(let e1):
        tuple.0 = e1
    case .e2(let e2):
...
private func set<T1: Result, T2: Result, T3: Result, T4: Result, T5: Result, T6: Result, T7: Result>(
    to tuple: inout Either<(T1.T?, T2.T?, T3.T?, T4.T?, T5.T?, T6.T?, T7.T?), Error>,
    value: OneOf7<T1, T2, T3, T4, T5, T6, T7>) -> Bool {
    do {
        switch tuple {
...
private func unwrap<T1, T2, T3, T4, T5, T6, T7>(
    tuple: (T1?, T2?, T3?, T4?, T5?, T6?, T7?)) -> (T1, T2, T3, T4, T5, T6, T7) {
    return (tuple.0!, tuple.1!, tuple.2!, tuple.3!, tuple.4!, tuple.5!, tuple.6!)
}

private func unwrap<T1, T2, T3, T4, T5, T6, T7>(
    tuple: Either<(T1?, T2?, T3?, T4?, T5?, T6?, T7?), Error>) -> Either<(T1, T2, T3, T4, T5, T6, T7), Error> {
    switch tuple {
